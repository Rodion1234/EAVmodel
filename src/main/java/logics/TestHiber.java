 ...
 * @author rodion
 */
public class TestHiber extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.println("Список полученых данных");

            ApplicationContext context = new ClassPathXmlApplicationContext("config.xml");
            HibernateWorkWithDB hwwdb = context.getBean("hibWWDB", HibernateWorkWithDB.class);
            
            System.out.println("Сущность: ");
            for (Entity entity : hwwdb.getListEntity()) {
                System.out.println(entity.toString());
            }
            
            System.out.println("Атрибуты: ");
            for (Attribute attribute : hwwdb.getListAttribute()) {
                System.out.println(attribute.toString());
            }
            
            System.out.println("Значения: ");
            for (Value value : hwwdb.getListValue()) {
